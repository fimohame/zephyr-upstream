...
static void gpio_silabs_irq_connect(const struct device *dev)
{
...
static const struct gpio_silabs_common_config gpio_silabs_common_config = {
	.irq_connect = gpio_silabs_irq_connect,
};
...
DEVICE_DT_DEFINE(DT_INST(0, silabs_gpio), gpio_silabs_common_init, NULL,
		 &gpio_silabs_common_data_inst, &gpio_silabs_common_config, PRE_KERNEL_1,
		 CONFIG_GPIO_SILABS_COMMON_INIT_PRIORITY, &gpio_silabs_common_driver_api);
